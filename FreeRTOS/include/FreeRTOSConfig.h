...
#define configTOTAL_HEAP_SIZE					((size_t)(20*1024))     //系统所有总的堆大小/*若分配的过大会导致内存不足此处分配为10K，请根据任务需要自行划分--不甘心的咸鱼注*/
...
#define INCLUDE_uxTaskGetStackHighWaterMark     1                       //为1时启用任务栈高水位检测 API
#define INCLUDE_xTimerPendFunctionCall	        1


/***************************************************************************************************************/
/*                                低功耗相关配置--不甘心的咸鱼编辑                                              */
/*								  嵌入式交流场地--443040359_qq											*/
/***************************************************************************************************************/
